...
@Data
public class HealthProposalInsuredPersonDTO {
  ...
  @ApiModelProperty(position = 23, example = "3", required = true)
  ...
  private List<HealthInsuredPersonBeneficiaryDTO> insuredPersonBeneficiariesList;
