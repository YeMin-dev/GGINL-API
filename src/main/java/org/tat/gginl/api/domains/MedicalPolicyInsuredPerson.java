...
public class MedicalPolicyInsuredPerson implements IInsuredItem, Serializable {
   ...
   * 
   * @JoinColumn(name = "MEDICALPOLICYID", referencedColumnName = "ID") private MedicalPolicy
   * medicalPolicy;
   */
  ...
  public MedicalPolicyInsuredPerson(MedicalProposalInsuredPerson insuredPerson) {
    ...
    for (MedicalProposalInsuredPersonKeyFactorValue keyFactorValue : insuredPerson
        .getKeyFactorValueList()) {
      addPolicyInsuredPersonKeyFactorValue(
          new MedicalPolicyInsuredPersonKeyFactorValue(keyFactorValue));
    }
  ...
  public List<MedicalPolicyInsuredPersonKeyFactorValue> getPolicyInsuredPersonkeyFactorValueList() {
    if (policyInsuredPersonkeyFactorValueList == null) {
      policyInsuredPersonkeyFactorValueList =
          new ArrayList<MedicalPolicyInsuredPersonKeyFactorValue>();
    }
    return policyInsuredPersonkeyFactorValueList;
  }

  public void setPolicyInsuredPersonkeyFactorValueList(
      List<MedicalPolicyInsuredPersonKeyFactorValue> policyInsuredPersonkeyFactorValueList) {
  ...
  public void addPolicyInsuredPersonKeyFactorValue(
      MedicalPolicyInsuredPersonKeyFactorValue keyFactorValue) {
  ...
  public double getTotalTermPremium() {
    return getBasicTermPremium() + getBasicPlusTermPremium() + getAddonTermPremium()
        - getTotalNcbPremium();
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (startDate == null) {
      ...
      return false;
    if (Double.doubleToLongBits(totalDiscountPremium) != Double
        .doubleToLongBits(other.totalDiscountPremium))
      return false;
